...
const styles = StyleSheet.create({
  serviceCard: {
    ...
    padding: Platform.OS === 'web' && typeof window !== 'undefined' && window.innerWidth < 400 ? 12 : (Platform.OS === 'web' && typeof window !== 'undefined' && window.innerWidth < 768 ? 16 : 20),
    borderRadius: 12,
    marginBottom: 16,
    alignItems: "center",
  ...
  serviceIcon: {
    fontSize: Platform.OS === 'web' && typeof window !== 'undefined' && window.innerWidth < 400 ? 24 : (Platform.OS === 'web' && typeof window !== 'undefined' && window.innerWidth < 768 ? 28 : 32),
    marginBottom: 12,
  },
  serviceTitle: {
    fontSize: Platform.OS === 'web' && typeof window !== 'undefined' && window.innerWidth < 400 ? 14 : (Platform.OS === 'web' && typeof window !== 'undefined' && window.innerWidth < 768 ? 16 : 18),
    fontWeight: "700",
    color: "#212529",
    marginBottom: 8,
  },
